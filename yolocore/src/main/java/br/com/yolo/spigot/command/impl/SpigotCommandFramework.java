...
public class SpigotCommandFramework extends SimpleCommandFramework {
    private CommandMap map;

    public SpigotCommandFramework(Plugin plugin) {
    ...
    public void registerServerCommand(Command tag) {
        ...
        map.register(management.getDescription().getName(), command);
    }
    ...
    class BukkitCommand extends org.bukkit.command.Command {
        ...
        public List<String> tabComplete(CommandSender sender, String alias, String[] args) throws IllegalArgumentException {
            List<String> completions = SpigotCommandFramework.this
